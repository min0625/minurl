...
import (
    ...
    ic76a889592d2056ba87feafa063739a745e7f9d102b4fcce89b7671c9b84b97e "github.com/min0625/minurl/pkg/kiota/go/gen/client/api"
)

// MinURLClient the main entry point of the SDK, exposes the configuration and the fluent API.
type MinURLClient struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// Api the api property
// returns a *ApiRequestBuilder when successful
func (m *MinURLClient) Api()(*ic76a889592d2056ba87feafa063739a745e7f9d102b4fcce89b7671c9b84b97e.ApiRequestBuilder) {
    return ic76a889592d2056ba87feafa063739a745e7f9d102b4fcce89b7671c9b84b97e.NewApiRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewMinURLClient instantiates a new MinURLClient and sets the default values.
func NewMinURLClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MinURLClient) {
    m := &MinURLClient{
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("http://localhost:8888")
    }
