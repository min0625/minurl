...
credentials, and without whitespace or control characters — both have to be percent-encoded,
or they land verbatim in the `Location` header. Anything else — `javascript:`, `data:`,
`file:`, `ftp:`, `//example.com`, `https://user@example.com/` — returns
